package com.capstone.basaliproject.notification
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    fun setRepeatingAlarm(context: Context, type: String, time: String, message: String) {
        ...
        Toast.makeText(context,
            context.getString(R.string.repeating_alarm_set_up), Toast.LENGTH_SHORT).show()
    }
    ...
    fun cancelAlarm(context: Context) {
        ...
        if (pendingIntent != null) {
            ...
            Toast.makeText(context,
                context.getString(R.string.notification_is_cancelled), Toast.LENGTH_SHORT).show()
        }
    }

    companion object {
        const val TYPE_REPEATING = "Notification"
