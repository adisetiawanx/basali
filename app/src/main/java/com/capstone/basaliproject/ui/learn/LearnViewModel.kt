...
class LearnViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun loadData(application: Application) {
        ...
        _learnData.value = listOf(
            ...
            LearnModel(4, R.drawable.cam_placeholder_logo, application.getString(R.string.aksara_modre), application.getString(R.string.desc_aksara_modre)),
            ...
            LearnModel(8, R.drawable.cam_placeholder_logo, application.getString(R.string.pangangge_ardhaswara), application.getString(R.string.desc_pangangge_ardhaswara))
            // Add more items here...
        )
    }
}
